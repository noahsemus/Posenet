...
function preload(){
  texHead = createImg(['GIFsSus/1.gif']);
  texHandL = createImg(['GIFsSus/2.gif']);
  texHandR = createImg(['GIFsSus/3.gif']);
  texShoulderL = createImg(['GIFsSus/4.gif']);
  texShoulderR = createImg(['GIFsSus/5.gif']);
  texKneeL = createImg(['GIFsSus/6.gif']);
  texKneeR = createImg(['GIFsSus/7.gif']);
